...
function updateRecord(ref, index) {
    ...
    ref.cells[0].innerHTML = "<input type='text' value='" + Employeeinfo[index].ninumber + "'>";
    ref.cells[0].innerHTML = "<input type='text' value='" + Employeeinfo[index].fullname + "'>";
    ref.cells[0].innerHTML = "<input type='text' value='" + Employeeinfo[index].phone + "'>";
    ref.cells[0].innerHTML = "<input type='text' value='" + Employeeinfo[index].address + "'>";
    ref.cells[0].innerHTML = "<input type='text' value='" + Employeeinfo[index].department + "'>";
    ref.cells[0].innerHTML = "<input type='text' value='" + Employeeinfo[index].Operations + "'>";
}
